...
public class DamageStatus {
    ...
    /**
     * Returns a DOT individual based on the table index of the bimsage damage table
     * @param i the table index, which is used in the bimsage damage table
    ...
    /**
     * Returns the name of the damage which is referenced by the given index in the bimsage damage table
     * @param i the table index, which is used in the bimsage damage table
