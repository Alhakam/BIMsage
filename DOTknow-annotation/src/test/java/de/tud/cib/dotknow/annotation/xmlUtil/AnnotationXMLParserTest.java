package de.tud.cib.dotknow.annotation.xmlUtil;
...
public class AnnotationXMLParserTest {
    ...
    String output = "src/test/resources/output/testOutput.xml";
    String xsdPath = "src/main/resources/annotationXSD/annotationSchema.xsd";
    String testXMLPath = "src/test/resources/testAnnotation.xml";
