...
public class OWLReasonerManagerTest {
    ...
    private String aboxPath = "src/main/test/resources/dotSampleData_v1.ttl";
    private String tboxURL = "https://alhakam.github.io/dot/ontology.ttl";
    private String infModelOutput = "src/main/test/resources/output/OWLOutput/infModelTest.ttl";
    private String mergedOntologyOutput = "src/main/test/resources/output/OWLOutput/renovationOntologyPhase1.ttl";
